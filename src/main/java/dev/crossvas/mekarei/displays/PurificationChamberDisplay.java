...
public class PurificationChamberDisplay extends BasicDisplay {

    ItemStackGasToItemStackRecipe RECIPE;

    public PurificationChamberDisplay(ItemStackGasToItemStackRecipe recipe) {
    ...
    public PurificationChamberDisplay(List<EntryIngredient> inputs, List<EntryIngredient> outputs) {
