...
public class Categories {
    ...
    public static final CategoryIdentifier<ChemicalInjectorDisplay> CHEMICAL_INJECTOR = of("chemical_injector");
    public static final CategoryIdentifier<ChemicalOxidizerDisplay> CHEMICAL_OXIDIZER = of("chemical_oxidizer");
    ...
    public static final CategoryIdentifier<CrusherDisplay> CRUSHER = of("crusher");
    ...
    public static final CategoryIdentifier<EnricherDisplay> ENRICHMENT = of("enrichment");
    public static final CategoryIdentifier<ItemStackToGasDisplay> ITEM_TO_GAS = of("item_to_gas");
    public static final CategoryIdentifier<IsotopicCentrifugeDisplay> ISOTOPIC_CENTRIFUGE = of("isotopic_centrifuge");
    ...
    public static final CategoryIdentifier<OsmiumCompressorDisplay> OSMIUM_COMPRESSOR = of("osmium_compressor");
    ...
    public static final CategoryIdentifier<PurificationChamberDisplay> PURIFICATION_CHAMBER = of("purification_chamber");
    public static final CategoryIdentifier<SolarNeutronDisplay> SOLAR_NEUTRON = of("solar_neutron");
